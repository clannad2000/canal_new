 ...
 * @Version1.0
 */
public class SqlForMapListHandler implements FieldMappingHandler {
    ...
    public Object dispose(Map<String, Object> sourceData, ESSyncConfig.ESMapping.FieldMapping fieldMapping, OpTypeEnum opTypeEnum) {
        ...
        return SqlUtil.queryForMapList(fieldMapping.getDataSourceKey(), fieldMapping.getSql(), params);
    }
}
